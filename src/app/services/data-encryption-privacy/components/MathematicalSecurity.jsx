        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div className="p-8 flex flex-col md:flex-row gap-4 items-center justify-center bg-slate-50/30">
              ...
              {/* Plain Text Side */}
              <div className="w-full md:w-1/2 bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest block mb-3">Plain Text</span>
                <div className="bg-gray-50 p-3 rounded border border-gray-100 font-mono text-xs text-gray-500">
                  CC: 4242-4242...
                </div>
              </div>

              {/* Secure Vault Side */}
              <div className="w-full md:w-1/2 bg-[#112240] p-4 rounded-xl shadow-xl relative overflow-hidden">
                <div className="flex justify-between items-start mb-3">
                  <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Xpace Vault</span>
                  <Lock size={14} className="text-red-500" />
                </div>
                <div className="bg-[#1a2d4d] p-3 rounded border border-blue-900/50 font-mono text-xs text-green-400 truncate">
                  U2FsdGVkX19...
                </div>
          ...
          <div className="space-y-5">
            {points.map((point, index) => (
              <div key={index} className="flex gap-5 group">
                ...
                <div>
                  <h3 className="text-primary font-bold text-md mb-2 transition-colors group-hover:text-red-600">
                    {point.title}
                  </h3>
...
export default MathematicalSecurity;